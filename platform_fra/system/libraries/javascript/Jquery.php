 ...
 * @category	Loader
 * @link		http://www.mobagepf.com/user_guide/libraries/javascript.html
 */
 
class MG_Jquery extends MG_Javascript {
	...
	{	
		...
		$controller = (strpos('://', $controller) === FALSE) ? $controller : $this->MG->config->site_url($controller);
		
		// ajaxStart and ajaxStop are better choices here... but this is a stop gap
		if ($this->MG->config->item('javascript_ajax_img') == '')
		{
			$loading_notifier = "Loading...";
		}
		else
		{
			$loading_notifier = '<img src=\'' . $this->MG->config->slash_item('base_url') . $this->MG->config->item('javascript_ajax_img') . '\' alt=\'Loading\' />';
		}
	...
	function _compile($view_var = 'script_foot', $script_tags = TRUE)
	{
		...
		$this->MG->load->vars(array('library_src' => $external_scripts));
		...
		$this->MG->load->vars(array($view_var => $output));
