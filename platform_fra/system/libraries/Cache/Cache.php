 ...
 * @link		
 */
class MG_Cache extends MG_Driver_Library {
	...
	protected $_adapter			= 'dummy'; //dummy
	...
	public function __construct($config = array())
	{
        ...
        {
            log_message('info',"cache class __construct no config");
        }
	}
	...
	{        
        log_message('info',"cache _initialize config:".$config['adapter']);
