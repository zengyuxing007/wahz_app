...
class MG_Driver_Library {
	...
	function __get($child)
	{
		...
		// Remove the MG_ prefix and lowercase
		$lib_name = ucfirst(strtolower(str_replace('MG_', '', $this->lib_name)));
		$driver_name = strtolower(str_replace('MG_', '', $child_class));
