 ...
 * @link		http://mobagepf.com/user_guide/libraries/cart.html
 */
class MG_Cart {
	...
	public function __construct($params = array())
	{
		...
		$this->MG->load->library('session', $config);

		// Grab the shopping cart array from the session table, if it exists
		if ($this->MG->session->userdata('cart_contents') !== FALSE)
		{
			$this->_cart_contents = $this->MG->session->userdata('cart_contents');
		}
		else
		{
	...
	function _save_cart()
	{
		...
		{
			$this->MG->session->unset_userdata('cart_contents');
		...
		$this->MG->session->set_userdata(array('cart_contents' => $this->_cart_contents));
