...
class Curl {
    ...
    public function execute()
    {
        ...
        if ($this->response === FALSE)
        {
            ...
            log_message('debug',"curl [".$this->url."] response false,error[$error]");
